...
Running in to MySQL docker crashes? 
[Connect to a managed MySQL instance for increased stability](./advanced-configuration.md#Connect-Cromwell-on-Azure-to-a-managed-instance-of-Azure-MySQL)<br/>
[Run Workflow](#How-to-prepare-files-to-run-a-workflow-on-Cromwell-on-Azure)<br/>
[Define runtime attributes for Cromwell on Azure TES backend](#How-to-define-the-runtime-attributes-in-a-WDL-workflow-for-Cromwell-on-Azure)<br/>
[Get Cromwell Workflow Id](#How-to-get-the-Cromwell-workflow-ID)<br/>
...
## [How to abort a workflow when using Cromwell on Azure](#AbortWorkflow)
...
## [Pricing for Cromwell on Azure](#CostAnalysis)
...
## [Dynamic cost optimization and RateCard API access](#RateCardAPI)
...
### [How to check all tasks running for a workflow using Batch account](#BatchAccount)
...
### [How to use Application Insights](#AppInsights)
